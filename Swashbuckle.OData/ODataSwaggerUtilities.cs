        ...
        public static PathItem CreateSwaggerPathForEntitySet(IEdmNavigationSource navigationSource)
        {
            ...
            return new PathItem
            {
                get = new Operation().Summary("Get EntitySet " + entitySet.Name)
                    ...
                    .Tags(entitySet.Name)
                    .Parameters(new List<Parameter>().Parameter("$expand", "query", "Expand navigation property", "string")
        ...
        public static PathItem CreateSwaggerPathForEntity(IEdmNavigationSource navigationSource)
        {
            ...
            return new PathItem
            {
                get = new Operation().Summary("Get entity from " + entitySet.Name + " by key.")
                    ...
                    .Tags(entitySet.Name)
                    .Parameters(keyParameters.DeepClone().Parameter("$select", "query", "description", "string"))
                    .Responses(new Dictionary<string, Response>().Response("200", "EntitySet " + entitySet.Name, entitySet.EntityType())
                        .DefaultErrorResponse()),
