...
namespace Swashbuckle.OData.ApiExplorer
{
    ...
    internal static class DictionaryExtensions
    {
        ...
        public static void RemoveFromDictionary<TKey, TValue>(this IDictionary<TKey, TValue> dictionary, Func<KeyValuePair<TKey, TValue>, bool> removeCondition)
        {
            ...
            dictionary.RemoveFromDictionary((entry, innerCondition) => { return innerCondition(entry); }, removeCondition);
        }
        ...
        /// </param>
        /// <returns>
        ///     <c>true</c> if key was found, value is non-null, and value is of type <typeparamref name="T" />; otherwise
        ///     false.
        /// </returns>
